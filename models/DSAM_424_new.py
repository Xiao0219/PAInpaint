    ...
    def register_reference_hooks(
        ...
        def hacked_basic_transformer_inner_forward(
            ...
            if MODE == "write":
                ...
                fused_attn_output = (
                    weights[0] * concat_self_attn_output +
                    weights[1] * target_self_attn_output +
                    weights[2] * direct_cross_attn_output
                )
        ...
        if self.reference_attn:
            ...
            for i, module in enumerate(attn_modules):
                ...
                # 为融合添加可学习的权重
                module.fusion_weights = torch.nn.Parameter(torch.zeros(3, device=device, dtype=dtype))
